...
public class cengdieAdapter extends RecyclerView.Adapter<cengdieAdapter.cengHolder>{
    private Context context;
    private List<HotNews.ResultBean> list;
    public cengdieAdapter(FragmentActivity context, List<HotNews.ResultBean> list) {
    ...
    public void setOnitemclick(cengdieAdapter.onitemclick onitemclick) {
