...
public class YingpingAdapter extends RecyclerView.Adapter<YingpingAdapter.yingpingHolder>{
    private Context context;
    private List<PinglunNews.ResultBean> list;
    public YingpingAdapter(Context context, List<PinglunNews.ResultBean> list) {
